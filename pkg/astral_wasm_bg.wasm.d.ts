...
export function b3_checksum(a: number, b: number, c: number, d: number): void;
export function b3_checksum_verify(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function encrypt_data(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function decrypt_data(a: number, b: number, c: number, d: number, e: number): void;
export function compress_data(a: number, b: number, c: number): void;
export function decompress_data(a: number, b: number, c: number): void;
